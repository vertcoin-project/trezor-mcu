...
const CoinType coins[COINS_COUNT] = {
	...
	{true, "Vertcoin",      true, " VTC",  true,   71, true,   10000000, true,    5, true, "\x19" "Vertcoin Signed Message:\n",  true, 0x0488b21e, true, 0x0488ade4, true, true,  false, 0, },
	{true, "Vertcoin Testnet", true, " TVTC", true,   74, true,   10000000, true,  196, true, "\x19" "Vertcoin Signed Message:\n",  true, 0x043587cf, true, 0x04358394, true, true,  false, 0, },
};
